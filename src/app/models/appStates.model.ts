/** APP_STATES from 1000 to 1007  */
export class APP_STATES {
    static readonly ADD_NEW_USER: number = 1000;
    static readonly AUTHENTICATE_USER: number = 1001;
    static readonly BMI_CALCULATION: number = 1002;
    static readonly EXERSICE: number = 1003;
    static readonly WEIGHT_GOAL: number = 1004;
